...
export default class NotifService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      bigText:
        'Anda Telah Konfirmasi Pesanan, lihat di Halaman Order untuk Informasi Selengkapnya', // (optional) default: "message" prop
      subText: 'Anda Telah Konfirmasi Pesanan Pada Pelanggan',
      ...
      subtitle: 'Anda Telah Konfirmasi Pesanan', // (optional) smaller title below notification title

      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: 'Konfirmasi Pesanan Pelanggan', // (optional)
      message: 'Anda Telah Konfirmasi Pesanan', // (required)
      userInfo: {screen: 'CostumerOrder'}, // (optional) default: {} (using null throws a JSON value '<null>' error)
  ...
  localNotifForeground(title, body, soundName) {
    ...
    PushNotification.localNotification({
      ...
      //   /* iOS only properties */
      category: '', // (optional) default: empty string
      subtitle: body, // (optional) smaller title below notification title
